...
var resizePizzas = function(size) {
  ...
  // Added the Web API and assigned to a var to avoid repetition.
...
/* Removed the function determinedx and changed the calculation from
 *pixels to percentage,width calculation is all done in changePizzaSize
 *func.Added the WebAPI.
 */
...
// Moved var outside loop for better performance.
...
/* declared the elem var outside the loop, added
 * WebAPI  and reduced the no: of pizza for better performance.
 */
document.addEventListener('DOMContentLoaded', function() {
  ...
  var elem;
  // TODO: dynamic calculation of pizza.
  for (var i = 0; i < 25; i++) {
